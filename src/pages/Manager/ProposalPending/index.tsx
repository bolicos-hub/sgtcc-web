...
const ManagerProposalPending: React.FC = () => {
  ...
  return isLoading ? (
    ...
    <>
      <Container>
        <Title>Propostas Pendentes</Title>
        <p>Esse é o formulário para criar uma nova Propostas.</p>
        <Space size="x-large" />
        <Row>
...
export default ManagerProposalPending;
